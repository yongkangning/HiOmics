task task_IntLIM_zhuanluzudaixiezu {
  String appBinDir
  String RLibPath
  String inputFile2
  String inputFile3
  ...
  command <<<
    ...
    #cp /henbio/henbio_web/public/demo_data/IntLIM_zhuanluzudaixiezu_he/IntLIM_input1.csv ./
...
workflow henbio_wf {
  call task_IntLIM_zhuanluzudaixiezu
  output{
      task_IntLIM_zhuanluzudaixiezu.outFile
  }
}
