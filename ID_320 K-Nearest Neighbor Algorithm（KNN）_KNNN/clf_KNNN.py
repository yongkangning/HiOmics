...
class myclf_KNN:
    ...
    def KNN_fit():
        global KNN_clf
        KNN_clf = KNeighborsClassifier(n_neighbors=25, algorithm="auto",metric='euclidean',leaf_size=30)
    ...
    def KNN_fit_diy(KNN_n_neighbors=25  
        ...
        global KNN_clf
        KNN_clf = KNeighborsClassifier(n_neighbors=KNN_n_neighbors
    ...
    def KNN_fit_cv(cv_times=cv_times, cv_scoring=None):
        ...
        parameters = {'algorithm': ('auto', 'brute','kd_tree','ball_tree')
    ...
    def load_model(file_name='KNN'):
        global fpr_KNN, tpr_KNN, KNN_clf, predictions
        if mode_choose == 'load_mode':
        ...
        if mode_choose == 'train' and cv_TF == 'T':
            report.loc['', ['algorithm']] = [best_para[0]]
            report.loc['', ['metric']] = [best_para[1]]
