task task_chromosome_density {
  ...
  command <<<  
   ...
   ulimit -s unlimited
    Rscript ${appBinDir}/chromosome_density_docker.R ${RLibPath} inputFile1.txt inputFile2.txt inputFile3.txt ${outputFileName}
	 >>>
...
workflow henbio_wf {
  call task_chromosome_density
  output{
    task_chromosome_density.outFile	
  }
}
