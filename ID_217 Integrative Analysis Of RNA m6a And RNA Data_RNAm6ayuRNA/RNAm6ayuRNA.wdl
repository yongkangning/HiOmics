task task_RNAm6ayuRNA {
  ...
  command <<<
    ...
    Rscript ${appBinDir}/Integration_docker_RNAm6ayuRNA_v2.0.R ${RLibPath} ${inputFile2} ${inputFile3} ${inputFile6} ${in_colname} ${category} ${plot} ${independentAnalyteOf_Interest} ${outcomeAnalyteOf_Interest} ${outputFileName}
    mkdir result
...
workflow henbio_wf {
  call task_RNAm6ayuRNA
  output{
    task_RNAm6ayuRNA.outFile
  }
}
