...
inputData <- IntLIM::ReadData(inputFile = "NCItestinput.csv",analyteType1id ='id',analyteType2id ='id', class.feat = list_class)
...
save_html(IntLIM::PlotDistributions(inputDatafilt, palette = c("#00CD66", "#B23AEE")), 
          file=paste(outputFileName,"Distributions.html",sep="_"), background = "white",libdir = paste(outputFileName,"lib",sep="_"))

save_html(IntLIM::PlotPCA(inputData = inputDatafilt,stype = in_colname,palette = c("#00CD66", "#B23AEE")), 
...
save_html(IntLIM::PlotPair(inputData = inputDatafilt,
                 ...
                 independentAnalyteOfInterest = independentAnalyteOf_Interest,palette = c("#00CD66", "#B23AEE")),	
...
inputData <- IntLIM::ReadData(inputFile = "NCItestinput.csv",analyteType1id ='id',analyteType2id ='id',
