...
if (length(args)!=argsCount) {
  stop("eQTL_docker_v1.1.R libPath inputFile1 inputFile2 inputFile3 usemodel pvOutputThreshold outputFileName")
}
.libPaths(args[1])
...
me = Matrix_eQTL_engine(  
  ...
  colnames(me_data)[2] <- "metab"  
write.table(me_data,file = paste(outputFileName,"metab.txt",sep="_"),sep = "\t",quote=F,row.names = F)  
